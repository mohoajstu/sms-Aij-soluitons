  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (error.message && (
        ...
        setErrorMessage('Network error: Could not connect to the SMS service. Please check your internet connection or the service endpoint.');
  ...
  return (
    <CCard>
      <CCardHeader className="d-flex justify-content-between align-items-center">
        ...
        <div>
          {isConfigChecking ? (
            <CBadge color="secondary">Checking SMS configuration... <CSpinner size="sm" /></CBadge>
          ) : smsConfigured === true ? (
