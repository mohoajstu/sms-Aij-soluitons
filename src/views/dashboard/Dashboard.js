...
const Dashboard = () => {
  ...
  <div className="header-left">
    {/* Logo / Sygnet Image */}
    <img src="/ois.png" alt="School Logo" className="school-logo" />
    
    {/* Title and subtitle */}
    <div>
      <h1 className="dashboard-title">OTTAWA ISLAMIC SCHOOL</h1>
  ...
  <div className="user-section">
    {/* Add your user info or other elements here */}
      ...
      <div className="dashboard-footer mt-4">
        <p className="footer-text">© 2025 Ottawa Islamic School</p>
      </div>
    </div>
  );
};
