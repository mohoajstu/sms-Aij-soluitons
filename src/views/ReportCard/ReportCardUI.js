...
import {
  ...
  selectIsLoading,
  selectRecentReports,
  selectReportCardState,
} from '../../store/features/reportCardSlice'

const ReportCardUI = () => {
  const dispatch = useDispatch()
  const [activeTab, setActiveTab] = useState(0)

  // Get state from Redux with fallback values
  const selectedSemester = useSelector(selectSelectedSemester) ?? null
  const selectedSection = useSelector(selectSelectedSection) ?? null
  const selectedStudent = useSelector(selectSelectedStudent) ?? null
  ...
  }, [selectedSemester, selectedSection, selectedStudent, isLoading, recentReports])
  ...
  const handleGenerateReport = () => {
    ...
    // Simulate loading and add to recent reports
    setTimeout(() => {
                    ...
                    <div className="rc-form-field">
                      ...
                      <Autocomplete
                        ...
                        onChange={(event, newValue) => {
                          dispatch(setSelectedSemester(newValue))
                        }}
                        renderInput={(params) => (
                          <TextField
                            {...params}
                  ...
                  <Grid item xs={12}>
                    <div className="rc-form-field">
                      ...
                      <Autocomplete
                        ...
                        onChange={(event, newValue) => {
                          dispatch(setSelectedSection(newValue))
                        }}
                        renderInput={(params) => (
                          <TextField
                            {...params}
                  ...
                  <Grid item xs={12}>
                    <div className="rc-form-field">
                      ...
                      <Autocomplete
                        ...
                        onChange={(event, newValue) => {
                          dispatch(setSelectedStudent(newValue))
                        }}
                        renderInput={(params) => (
                          <TextField
                            {...params}
