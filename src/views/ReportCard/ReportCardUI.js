  ...
  return (
    <div className="rc-container">
      ...
      <div className="rc-header">
        <Typography variant="h4" className="rc-title">Student Report Cards</Typography>
          ...
          {!selectedStudent ? (
            <Paper elevation={3} className="rc-selection-form">
              <div className="rc-form-header">
                <Typography variant="h6" className="rc-form-title">Select Student Information</Typography>
        ...
        <CTabPane visible={activeTab === 1} className="rc-tab-pane">
          <Paper elevation={3} className="rc-history-container">
            <div className="rc-history-header">
              <Typography variant="h6" className="rc-history-title">Recently Generated Reports</Typography>
            ...
            {recentReports.length > 0 ? (
                ...
                {recentReports.map(report => (
                  <Paper key={report.id} elevation={1} className="rc-history-item">
                    <div className="rc-history-item-content">
                      <Typography variant="subtitle1" className="rc-student-name">{report.student}</Typography>
                      <div className="rc-history-meta">
                        <Typography variant="body2" className="rc-semester-info">{report.semester}</Typography>
                        <Typography variant="body2" className="rc-date-info">Generated: {report.date}</Typography>
                      </div>
                    </div>
                    <Button variant="outlined" className="rc-btn-view">View Report</Button>
                  </Paper>
                ))}
              </div>
            ) : (
              <div className="rc-empty-state">
                ...
                <Typography variant="body2">No previous report cards have been generated yet.</Typography>
              </div>
            )}
          </Paper>
        </CTabPane>
