/**
 * Export utility for Kindergarten Initial Observations Report
...
/**
 * Generate and download a filled PDF for KG Initial Observations
 ...
 */
export const exportKGInitialObservations = async (pdfPath, formData, studentName) => {
  console.log('📄 Starting KG Initial Observations export...')
  ...
  try {
    ...
    // Logo overlay removed for KG Initial Observations
    ...
    await updateAllFieldAppearances(form, pdfDoc, 'Download KG')
    ...
    console.error('❌ Error generating KG Initial Observations PDF:', error)
    throw error
  }
}
